...
<!--feature-->
<div class="px-5">
  <p style="font-size: 30px;">Apple <i class="fa-brands fa-apple"></i></p>
</div>
    ...
    <div class="row">
      <div class="col-md-4 mb-2">
        <div class="card" style="height: 410px;">
            <img src="https://cdn2.cellphones.com.vn/358x358,webp,q100/media/catalog/product/p/r/pro-m2.jpg" class="card-img-top" alt="..." width="250px" height="200px" style="transition: transform .2s;">
            <div class="card-body">
                <h5 class="card-title">Apple Macbook Pro 13 M2 2022 8GB 256GB</h5>
                <p class="card-text" style="position: absolute; top: 66%; left: 5%;">Category: <a href="#">Laptop</a></p>
      ...
      <div class="col-md-4 mb-2">
        <div class="card" style="height: 410px;">
            ...
            <div class="card-body">
                <h5 class="card-title">Smart Phone Pro Mechanical Keyboard</h5>
                <p class="card-text" style="position: absolute; top: 66%; left: 5%;">Category: <a href="#">Logitech</a></p>
                <p class="card-text" style="position: absolute; top: 76%; left: 5%;">Price: 1.999.999VND</p>
                <a href="#" class="btn btn-info" style="position: absolute; top: 86%; left: 5%;">Add to cart</a>
                <a href="../product_details.php" class="btn btn-secondary" style="position: absolute; top: 86%; left: 35%;">View more</a>
            </div>
      ...
      <div class="col-md-4 mb-2">
        <div class="card" style="height: 410px;">
            <img src="https://cdn2.cellphones.com.vn/358x358,webp,q100/media/catalog/product/m/2/m2_256gb.png" class="card-img-top float-start" alt="..." width="250px" height="200px" style="transition: transform .2s;">
            <div class="card-body">
                <h5 class="card-title">Mac Mini M2 2023</h5>
                <p class="card-text" style="position: absolute; top: 66%; left: 5%;">Category: <a href="#">Laptop</a></p>
