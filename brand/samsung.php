...
<!--feature-->
<div class="px-5">
  <p style="font-size: 30px;">Samsung <span class="iconify" data-icon="simple-icons:samsung"></span></p>
</div>
    ...
    <div class="row">
      <div class="col-md-4 mb-2">
        <div class="card" style="height: 410px;">
            <img src="https://cdn2.cellphones.com.vn/358x358,webp,q100/media/catalog/product/s/a/samsung_galaxy_z_flip_m_i_2022-1_1.jpg" class="card-img-top" alt="..." width="250px" height="200px" style="transition: transform .2s;">
            <div class="card-body">
                <h5 class="card-title">Samsung Galaxy Z Flip4 128GB</h5>
                <p class="card-text" style="position: absolute; top: 66%; left: 5%;">Category: <a href="../category/smartphone.php">Smart Phone</a></p>
                <p class="card-text" style="position: absolute; top: 76%; left: 5%;">Price: 30.090.000VND</p>
      ...
      <div class="col-md-4 mb-2">
        <div class="card" style="height: 410px;">
            <img src="https://cdn2.cellphones.com.vn/358x358,webp,q100/media/catalog/product/_/g/_global-version_-sm-s911_galaxys23_back_cream_221122.jpg" class="card-img-top" alt="..." width="250px" height="200px" style="transition: transform .2s;">
            <div class="card-body">
      ...
      <div class="col-md-4 mb-2">
        <div class="card" style="height: 410px;">
            <img src="https://cdn2.cellphones.com.vn/358x358,webp,q100/media/catalog/product/t/a/tab_s8_2.jpg" class="card-img-top" alt="..." width="250px" height="200px" style="transition: transform .2s;">
            <div class="card-body">
      ...
      <div class="col-md-4 mb-2">
        <div class="card" style="height: 410px;">
            <img src="https://cdn2.cellphones.com.vn/358x358,webp,q100/media/catalog/product/3/_/3_51_1_7.jpg" class="card-img-top" alt="..." width="250px" height="200px" style="transition: transform .2s;">
            <div class="card-body">
                <h5 class="card-title">iPhone 13 Pro Max 128GB</h5>
                <p class="card-text" style="position: absolute; top: 66%; left: 5%;">Category: <a href="#">Smart Phone</a></p>
                <p class="card-text" style="position: absolute; top: 76%; left: 5%;">Price: 25.799.999VND</p>
                <a href="#" class="btn btn-info" style="position: absolute; top: 86%; left: 5%;">Add to cart</a>
                <a href="../product_details.php" class="btn btn-secondary" style="position: absolute; top: 86%; left: 35%;">View more</a>
            </div>
        </div>        
      ...
      <div class="col-md-4 mb-2">
        <div class="card" style="height: 410px;">
            <img src="https://cdn2.cellphones.com.vn/358x358,webp,q100/media/catalog/product/s/2/s23-ultra-tim.png" class="card-img-top float-start" alt="..." width="250px" height="200px" style="transition: transform .2s;">
            <div class="card-body">
      ...
      <div class="col-md-4 mb-2">
        <div class="card" style="height: 410px;">
            <img src="https://cdn2.cellphones.com.vn/358x358,webp,q100/media/catalog/product/g/r/group_170_9.png" class="card-img-top float-start" alt="..." width="250px" height="200px" style="transition: transform .2s;">
            <div class="card-body">
      ...
      <div class="col-md-4 mb-2">
        <div class="card" style="height: 410px;">
            <img src="https://cdn2.cellphones.com.vn/358x358,webp,q100/media/catalog/product/m/a/macbook_spa.png" class="card-img-top float-start" alt="..." width="250px" height="200px" style="transition: transform .2s;">
            <div class="card-body">
